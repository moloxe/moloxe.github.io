import{R as a}from"./ReTina.BWp5I4CI.js";const t=document.createElement("canvas");t.width=window.innerWidth*window.devicePixelRatio;t.height=window.innerHeight*window.devicePixelRatio;t.style.width=`${window.innerWidth}px`;t.style.height=`${window.innerHeight}px`;document.body.appendChild(t);const i=new a({canvas:t});i.registerMaterial({sdFunc:`
    let t = U.time * .3;
