import{R as o}from"./ReTina.B5BpWoZE.js";const e=new o({functions:`
    const nPoints = 12;
    const power = 2f;
  ...
  `}),s=e.registerUniform("mouseX"),t=e.registerUniform("mouseY");e.start({onBuild(){document.addEventListener("mousemove",i=>{s(i.clientX),t(i.clientY)})}});
