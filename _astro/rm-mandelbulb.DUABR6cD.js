import{R as t}from"./ReTina.D3-UZcjL.js";import{f as o,a}from"./freeControls.mEnd03r0.js";const r=document.createElement("canvas");r.width=window.innerWidth*window.devicePixelRatio;r.height=window.innerHeight*window.devicePixelRatio;r.style.width=`${window.innerWidth}px`;r.style.height=`${window.innerHeight}px`;document.body.appendChild(r);const e=new t({canvas:r,main:`
