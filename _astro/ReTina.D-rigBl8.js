...
`;function U({sdWGSL:a,materialSdFunctions:r}){function e(s,i){const l=`vec3<f32>(U.material${i}Px, U.material${i}Py, U.material${i}Pz)`,c=`vec3<f32>(U.material${i}Rx, U.material${i}Ry, U.material${i}Rz)`;return`
...
`)}
      ...
      return material;
    `;return a=a.replace("// #SD-MATERIALS-FUNC",o),a}function I({materialSdFunctions:a,sdWGSL:r}){function e(n){return`dist = min(dist, sdMaterial${n}(pos));`}const t=`
      var dist: f32 = INF;
      var accDist: f32;
...
`)}
      ...
      return dist;`;return r=r.replace("// #MAP",t),r}function R({materialLightFunctions:a,sdWGSL:r}){function e(s,i){return s||(s=`
...
`);r=r.replace("// #LIGHT-INDIVIDUAL-MATERIALS",t);function n(s){return`
      ...
      ${a.map((s,i)=>n(i)).join(`
`)}
      return finalColor;`;return r=r.replace("// #LIGHT-MATERIALS-FUNC",o),r}function M(a){let r=_;const e=a.map(n=>n.sdFunc),t=a.map(n=>n.lightFunc);return r=U({sdWGSL:r,materialSdFunctions:e}),r=I({materialSdFunctions:e,sdWGSL:r}),r=R({sdWGSL:r,materialLightFunctions:t}),r}function T({functions:a,rtUniformKeys:r,materialFuncs:e,nTextures:t,usePrevFrameTex:n}){let o=z;if(o=o.replace("UNIFORMS: f32, // #UNIFORMS",r.map(s=>`${s}: f32,`).join(`
...
`);o=o.replace("// #GROUP-1-BINDING-X",i)}if(n&&(o=o.replace("// #GROUP-2-BINDING-X",`
      ...
      }`)),a&&(o=o.replace("// #FUNCTIONS",a)),e.length>0){const s=M(e);o=o.replace("// #RAY_MARCH_FUNCTIONS",s)}return o}function D({main:a,functions:r,rtUniformKeys:e,materialFuncs:t,nTextures:n,usePrevFrameTex:o,useInterlacing:s}){const i=T({functions:r,materialFuncs:t,nTextures:n,rtUniformKeys:e,usePrevFrameTex:o});t.length>0&&!a&&(a=`
