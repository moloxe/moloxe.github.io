...
`;function C({sdWGSL:a,materialSdFunctions:r}){function e(s,o){const c=`vec3<f32>(U.material${o}Px, U.material${o}Py, U.material${o}Pz)`,u=`vec3<f32>(U.material${o}Rx, U.material${o}Ry, U.material${o}Rz)`;return`
...
`)}
      ...
      return dist;`;return r=r.replace("// #MAP",t),r}function _({materialLightFunctions:a,sdWGSL:r}){function e(s,o){return s||(s=`
...
`);r=r.replace("// #LIGHT-INDIVIDUAL-MATERIALS",t);function n(s){return`
      ...
      ${a.map((s,o)=>n(o)).join(`
`)}
      return finalColor;`;return r=r.replace("// #LIGHT-MATERIALS-FUNC",i),r}function G(a){let r=I;const e=a.map(n=>n.sdFunc),t=a.map(n=>n.lightFunc);return r=C({sdWGSL:r,materialSdFunctions:e}),r=U({materialSdFunctions:e,sdWGSL:r}),r=_({sdWGSL:r,materialLightFunctions:t}),r}function M({functions:a,rtUniformKeys:r,materialFuncs:e,nTextures:t,usePrevFrameTex:n}){let i=z;if(i=i.replace("UNIFORMS: f32, // #UNIFORMS",r.map(s=>`${s}: f32,`).join(`
...
`);i=i.replace("// #GROUP-1-BINDING-X",o)}if(n&&(i=i.replace("// #GROUP-2-BINDING-X",`
      ...
      }`)),a&&(i=i.replace("// #FUNCTIONS",a)),e.length>0){const s=G(e);i=i.replace("// #RAY_MARCH_FUNCTIONS",s)}return i}function F({main:a,functions:r,rtUniformKeys:e,materialFuncs:t,nTextures:n,usePrevFrameTex:i,useInterlacing:s}){const o=M({functions:r,materialFuncs:t,nTextures:n,rtUniformKeys:e,usePrevFrameTex:i});t.length>0&&!a&&(a=`
